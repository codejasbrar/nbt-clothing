...
window.addEventListener('load', () => {
    ...
    $('.truncate').each(function() {
      ...
      if (content.length > showChar) {
        ...
        var html =
          ...
          ellipsestext +
          '&nbsp;&nbsp;<a href="" class="readmore more">Read More</a></span></span></div><div class="truncate-text" style="display:none">' +
          fullText +
          '<a href="" class="readmore less">Less</a></span></div>';
  ...
  $('[data-popup-trigger]').each(function(){
  	var trigger = $(this)
  	var dataTarget = trigger.data('popup-trigger');
    var dataSource = $('[data-popup="'+dataTarget+'"]');
...
$('a[href*="#"]:not([href="#"])').click(function() {
  ...
  $('[class^=PwzrButtonBase-root]').on('click',function(){
    $('.product-single__variants').trigger('change');
  });
  
  
  $('.product-single__variants').on('change',function() {
    console.log('singl variant change');
    var value = $(this).val();
    
    $('.sections-single-select').val(value);
  });  
